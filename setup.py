...
FOLDER = "myherdingspikes/detection_localisation/"
...
def get_pkg_version():
    ...
    with open("myherdingspikes/version.py") as fp:
        exec(fp.read(), version)

    # Store the commit hash for when we don't have access to git
    with open("myherdingspikes/.commit_version", 'w') as cf:
...
detect_ext = Extension(name="myherdingspikes.detection_localisation.detect",
                       sources=sources,
                       language="c++",
...
setup(
    ...
    #
    # py_modules=['myherdingspikes/hs2',
    #             'myherdingspikes/detection_localisation/detect',
    #             'myherdingspikes/probe',
    #             'myherdingspikes/parameter_optimisation',
    #             'myherdingspikes/clustering/mean_shift_',
    #             'myherdingspikes/probe_functions/readUtils'],  # Required
    ...
    install_requires=['matplotlib >= 2.0', 'pandas'],
    python_requires='>=3.6',
    ...
    package_data={  # Optional
        'myherdingspikes': ['.commit_version',
